...
class Migration(migrations.Migration):
    ...
    dependencies = [    #the migration depends on the authencatication app and 0001_initial.py, which means that changes can only be made once the 0001_initial.py runs
